    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.CharField(editable=False, max_length=500)),
                ('date_modification', models.DateTimeField(auto_now=True)),
                ('client', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, to='api_gc.clients', verbose_name='Client')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Tva',
            fields=[
                ('valeur', models.DecimalField(decimal_places=3, default=0, max_digits=38, primary_key=True, serialize=False, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)], verbose_name='TVA')),
                ('est_bloquer', models.BooleanField(default=False, editable=False)),
                ('user_id', models.CharField(editable=False, max_length=500)),
                ('date_modification', models.DateTimeField(auto_now=True)),
            ],
        ...
        migrations.AddField(
            model_name='contrat_latest',
            name='tva',
            field=models.ForeignKey(db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api_gc.tva', verbose_name='TVA'),
        ),
        migrations.CreateModel(
            name='Contrat',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.CharField(editable=False, max_length=900, primary_key=True, serialize=False)),
                ('qte', models.DecimalField(decimal_places=3, default=0, max_digits=38)),
                ...
                ('user_id', models.CharField(editable=False, max_length=500)),
                ('date_modification', models.DateTimeField(auto_now=True)),
                ('contrat', models.ForeignKey(db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api_gc.contrat_latest', verbose_name='Contrat')),
