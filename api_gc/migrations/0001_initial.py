# Generated by Django 4.2.13 on 2024-07-21 08:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.CharField(editable=False, max_length=500)),
                ('date_modification', models.DateTimeField(auto_now=True)),
                ('contrat', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, to='api_gc.contrat_latest', verbose_name='Contrat')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.CharField(editable=False, max_length=500)),
                ('date_modification', models.DateTimeField(auto_now=True)),
                ('act', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api_gc.activite', verbose_name='Activite')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_prix', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='api_gc.typeprix', verbose_name='TypePrix')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tva', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api_gc.tva', verbose_name='TVA')),
            ],
            options={
                'verbose_name': 'Contrats',
                'verbose_name_plural': 'Contrats',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('num_bl', models.IntegerField(default=api_gc.models.get_num_bl)),
                ...
                ('dqe', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, to='api_gc.dqecumule', verbose_name='dqe')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_modification', models.DateTimeField(auto_now=True)),
                ('contrat', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, to='api_gc.contrat_latest', verbose_name='Contrat')),
                ('dqe', models.ForeignKey(db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api_gc.dqecumule', verbose_name='dqe')),
            ],
            options={
